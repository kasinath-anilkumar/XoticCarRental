 ...
 */
export const styles = {
  shell: "grid min-h-dvh grid-cols-[232px_minmax(0,1fr)] items-start max-lg:grid-cols-1",
  ...
  sidebarFoot: "mt-auto border-t border-[var(--color-divider)] pt-6 text-[11px] text-[var(--color-neutral-500)] [overflow-wrap:anywhere] max-lg:hidden",
  main: "min-w-0 p-12 [overflow-wrap:anywhere] max-lg:px-[var(--gutter-mobile)] max-lg:py-8",
  ...
  card: "mb-6 min-w-0 rounded-md bg-surface p-8 shadow-[var(--shadow-sm)] max-md:p-5",
  cardTitle: "mt-0 mb-[4px] font-[family-name:var(--font-heading)] text-[17px]",
  cardHint: "mt-0 mb-6 text-[12px] text-[var(--color-neutral-500)]",
  grid2: "grid grid-cols-2 gap-4 [&>*]:min-w-0 max-md:grid-cols-1",
  grid3: "grid grid-cols-3 gap-4 [&>*]:min-w-0 max-lg:grid-cols-2 max-md:grid-cols-1",
  grid4: "grid grid-cols-4 gap-4 [&>*]:min-w-0 max-lg:grid-cols-2 max-md:grid-cols-1",
  actions: "mt-6 flex flex-wrap items-center gap-3",
  stats: "mb-8 grid grid-cols-4 gap-4 max-lg:grid-cols-2",
  stat: "min-w-0 rounded-md bg-surface p-6 shadow-[var(--shadow-sm)] [overflow-wrap:anywhere]",
  ...
  right: "text-right",
  rowForm: "flex flex-wrap items-center gap-3 [&>*]:min-w-0 [&_.input]:max-w-[140px]",
  ...
  loginPage: "grid min-h-dvh min-w-0 place-items-center p-12 max-md:p-5",
  loginCard: "min-w-0 w-[min(400px,100%)] rounded-lg bg-surface p-12 shadow-[var(--shadow-md)] [overflow-wrap:anywhere] max-md:p-6",
